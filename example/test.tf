...
resource "kintone_application" "test_application_1" {
  ...
  state = { name = "New" index = 0 }
  state = { name = "InProgress" index = 1 }
  state = { name = "Done" index = 2 }

  action = { name = "InProgress!!" from = "New" to = "InProgress" }
  action = { name = "Done!!Done" from = "InProgress" to = "Done" }
}
